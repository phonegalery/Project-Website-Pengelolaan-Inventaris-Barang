                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <img src="<?= base_url('gambar/logo_pln.jpg'); ?>" alt="Logo PLN Indonesia Power" class="mb-3" style="width: 100px;">
                                        <h1 class="h4 text-gray-900">Website Inventarisas Barang</h1>
                                        <h1 class="h4 text-gray-900">PT PLN INDONESIA POWER UBP SEMARANG</h1>
