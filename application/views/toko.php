...
<body id="page-top">
							...
							<div class="card-body">
								<form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
									<div class="form-group">
										<label for="nama_toko"><strong>Nama Sistem : </strong></label>
										<input type="text" name="nama_toko" id="nama_toko" 
										value="<?= isset($toko->nama_toko) ? $toko->nama_toko : 'Nama Toko Tidak Tersedia' ?>" 
										placeholder="Masukan Nama Toko" class="form-control" readonly>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="no_telepon"><strong>No Telepon : </strong></label>
	...
	<!-- Script untuk mengubah nama sistem di topbar -->
	<script>
	    $(document).ready(function() {
	        $('#ubah').on('click', function() {
	            // Mengizinkan pengeditan pada form
	        ...
	        $('button[type="reset"]').on('click', function() {
	            // Kembalikan form menjadi readonly
	        ...
	        // Event listener saat input pada nama toko berubah
	        $('#nama_toko').on('input', function() {
	            // Update teks nama sistem di topbar
	            $('#topbar-system-name').text($(this).val());
	        });
	    });
	</script>
</body>
