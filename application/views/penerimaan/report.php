...
<div class="container-fluid">
    ...
    <div class="card-body" style="padding: 0;">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php if (!empty($all_penerimaan)): ?>
                    <?php foreach ($all_penerimaan as $index => $penerimaan): ?>
                        <tr>
                            <td><?= $index + 1; ?></td>
                            <td><?= htmlspecialchars($penerimaan->no_terima, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?= htmlspecialchars($penerimaan->nama_barang, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?= htmlspecialchars($penerimaan->jenis_barang, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?= htmlspecialchars($penerimaan->jumlah, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?= htmlspecialchars($penerimaan->supplier, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?= htmlspecialchars($penerimaan->tgl_terima . ' ' . $penerimaan->jam_terima, ENT_QUOTES, 'UTF-8'); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
