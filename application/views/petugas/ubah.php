								...
								<form action="<?= base_url('petugas/proses_ubah/' . $petugas->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="nip" placeholder="Masukkan NIP" autocomplete="off"  class="form-control" required value="<?= $petugas->nip ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="username" placeholder="Masukkan Username" autocomplete="off"  class="form-control" required value="<?= $petugas->username ?>" >
										</div>
										<div class="form-group col-md-6">
