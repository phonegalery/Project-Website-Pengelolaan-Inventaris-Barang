...
<head>
    ...
    <title>pengelola - Register</title>
    ...
    <style>
        .bg-register-image {
            background-image: url("<?= base_url('sb-admin/img/register.png'); ?>");
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center mb-4">
                                        ...
                                        <span class="text-muted">Silahkan Isi Data Dibawah</span>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="p-5">
                                                ...
                                                <form class="user" method="POST" action="<?= base_url('login/proses_register') ?>">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="name" placeholder="Masukkan Nama Lengkap" autocomplete="off" required name="name">
                                                    </div>
                                                    <div class="form-group">
