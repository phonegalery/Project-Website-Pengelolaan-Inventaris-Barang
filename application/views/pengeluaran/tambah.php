										...
										<div class="col-md-8">
											...
											<div class="form-row">
												...
												<div class="form-group col-2">
													...
													<input type="text" name="kode_perangkat" value="" readonly class="form-control">
												</div>
												<div class="form-group col-2">
													<label>Jumlah</label>
		...
		$(document).ready(function(){
				...
				if($(this).val() == '') reset()
					...
					$.ajax({
						...
						success: function(data){
							$('input[name="kode_perangkat"]').val(data.kode_perangkat)
			...
			$(document).on('click', '#tambah', function(e){
				...
				const data_keranjang = {
					...
					kode_perangkat: $('input[name="kode_perangkat"]').val(),
			...
			$('button[type="submit"]').on('click', function(){
				$('input[name="kode_perangkat"]').prop('disabled', true)
